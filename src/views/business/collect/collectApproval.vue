<template>
    <div class="body">
        ...
        <div class="tableBox">
          <a-table class="table" :dataSource="dataSource" :columns="columns" :pagination="pagination"  @change="changePage" :loading="tableLoading">
            <!-- 表头插槽 -->
  ...
  import {collectApi} from '/@/api/business/collect/collect-api.js'
  ...
  // 方法------------------------------------------------------
    ...
    // 获取table数据
  const getTable = ()=>{
      collectApi.queryApprovalPage(form).then((res)=>{
