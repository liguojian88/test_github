...
<template>
  ...
  <div class="logo"  :style="sideMenuWidth" v-if="!collapsed">
    <!-- <img class="logoNew" :src="logoImg" /> -->
    <div class="title smart-logo title-light" v-if="sideMenuTheme === 'light'">WeCom File Transfer</div>
    <div class="title smart-logo title-dark" v-if="sideMenuTheme === 'dark'">WeCom File Transfer</div>
  </div>
