...
export default {
  ...
  server: {
    ...
    proxy: {
      // 只代理 API 请求，不代理静态资源
      '/prod-api': {
        // target: 'https://haleonfileback.smartone.net.cn', // 老服务器地址
        // target: 'https://wcft.haleon.cn', //heliang正式
        target: 'https://wcft.corpnet5.com',  //heliang测试
        changeOrigin: true, // 是否修改请求头中的 Origin 字段
        rewrite: (path) => path, // 保持路径不变（已经包含 /prod-api）
